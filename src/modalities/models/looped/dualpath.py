...
class DualPathLLMConfig(BaseModel):
    sample_key: str
    prediction_key: str
...
class AdaptiveRecursiveBlock(nn.Module):
    def __init__(
        self,
        block: Optional[DualPathBlock],
        adaptive_config: AdaptiveComputationConfig,
        n_embd: int,
        layer_idx: int,
        n_layers: int,
        wide_block: Optional[DualPathBlock] = None,
        layer_type: str = "dual",
    ):
        super().__init__()
...
# =============================================================================
# DualPathLLM — Main Model
# =============================================================================

class DualPathLLM(NNModel):
    def __init__(
        ...
        use_weight_tying, enforce_swiglu_hidden_dim_multiple_of=32,
