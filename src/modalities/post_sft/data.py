...
def load_single_dataset(
    dataset_name: str, subset: str = None, split: str = "train", max_samples: int = None, seed: int = 42
):
...
def load_datasets(dataset_string: str, total_samples: int = None, eval_ratio: float = 0.001, seed: int = 42):
    ...
    split_dataset = shuffled_dataset.train_test_split(test_size=eval_ratio, seed=seed)
