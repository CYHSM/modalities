...
class AlignmentConfig:
    """Configuration for hidden state alignment with teacher model."""
    teacher_model_name_or_path: Optional[str] = None
    alignment_loss_type: str = "mse"  # "mse" or "cosine"
    alignment_weight: float = 1.0
    teacher_gpu: int = 1  # GPU device for teacher model
    teacher_model_init_kwargs: dict = field(default_factory=dict)
