...
#SBATCH --qos=normal #normal boost_qos_bprod boost_qos_dbg
#SBATCH --nodes=64
...
# Define base paths
EXPERIMENT_ROOT="/leonardo_work/EUHPC_E05_119/mluebber/experiments/modalities-${SLURM_JOB_NAME}-${SLURM_JOB_ID}" # "$SLURM_SUBMIT_DIR/../../training_runs/modalities-${SLURM_JOB_NAME}-${SLURM_JOB_ID}"
...
modalities_config_file="configs/soofi_llama3_8b.yaml"
