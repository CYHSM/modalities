...
last_checkpoint_info_file_path="/leonardo_work/EUHPC_E05_119/mluebber/experiments/modalities-llama8B-34702229/train/checkpoints/last_checkpoint_info.json"
...
modalities_config_file="configs/soofi_llama3_3b_warmstart.yaml"
