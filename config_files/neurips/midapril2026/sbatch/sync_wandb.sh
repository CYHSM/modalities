...
SCRATCH_ROOT="/leonardo_scratch/fast/EUHPC_D21_101/mfrey"
# SCRATCH_ROOT="/leonardo_scratch/large/userexternal/mfrey000"
WANDB_DIR="${SCRATCH_ROOT}/experiments/wandb/wandb"
TARGET_PROJECT="widedeep"
...
if wandb beta sync "$WANDB_DIR" --live -p "$TARGET_PROJECT"; then
    echo "✅ Sync complete."
else
