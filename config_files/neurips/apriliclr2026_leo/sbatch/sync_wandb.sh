...
SCRATCH_ROOT="/leonardo_scratch/large/userexternal/mfrey000/experiments_midapril"
# SCRATCH_ROOT="/leonardo_scratch/large/userexternal/mfrey000"
WANDB_DIR="${SCRATCH_ROOT}/wandb/wandb"
TARGET_PROJECT="dualcross"
...
if wandb beta sync "$WANDB_DIR" --live -p "$TARGET_PROJECT" -n 20; then
    echo "✅ Sync complete."
else
